package jab.sledgehammer.permissions
 ...
 * @property group
 */
class PermissionUser(id: UUID = UUID.randomUUID(), name: String, var group: PermissionGroup? = null) : PermissionCollection(id, name) {
